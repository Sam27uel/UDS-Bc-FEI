...
class Odometry:
    ...
    def update(self, linear_distance, angular_distance):
        ...
        # Update pose
        x, y, theta = self.pose
        x += linear_distance * np.cos(theta)
        y += linear_distance * np.sin(theta)
...
class LidarTeleop(Node):
    def __init__(self):
        ...
        # Attribute for wall approaching progress
    ...
    def print_distance_info(self):
        if 'front' in self.distance_readings:
            ...
            print(f"Distance to front wall: {front_distance} meters")
        ...
        if 'left' in self.distance_readings:
            ...
            print(f"Distance to left wall: {left_distance} meters, Angle: {left_angle}°")
